<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VideoPage.aspx.cs" Inherits="PTAFINALYEAR.VideoPage" %>
                ...
                <ItemTemplate>
                    <div class="video-item">
                        <div class="video-details">
                            <h3><%# Eval("videoTittle") %></h3>
                            <p><%# Eval("videoLink") %></p>
                        </div>
                        <div class="video-image">
                            <img src='<%# Eval("videoImage") %>' alt="Video Thumbnail" />
                        </div>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
